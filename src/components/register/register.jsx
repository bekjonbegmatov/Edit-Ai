        ...
        <div className='' >
            ...
            {!is_register &&
                <div className='forma'>
                    ...
                    <input type="text" className='form form-control' onChange={get_login} value={login} placeholder='Login' />
                    <br />
                    <input type="password" onChange={get_password} value={auth_password} className='form form-control' placeholder='Пароль' />
                    <p>{err}</p>
                    <br />
                    <p> ещё нет аккаунта ? <i className='blue' onClick={() => {
                        if (is_register) {
                ...
                <div className='forma'>
                    ...
                    <input type="text" className='form form-control' onChange={get_name} value={name} placeholder='Имя' />
                    <br />
                    <input type="text" onChange={get_email} value={email} className='form form-control' placeholder='Email' />
                    <br />
                    <input type="password" onChange={get_r_passwod} value={r_password} className='form form-control' placeholder='Пароль' />
                    <br />
                    <p> Уже есть аккаунта ? <i className='blue' onClick={() => {
                        if (is_register) {
                            setIs_register(false)
                        } else {
                            setIs_register(true)
                    ...
                    <button className='btn btn-light' onClick={register_user}>Регистрация</button>
                </div>
            }
